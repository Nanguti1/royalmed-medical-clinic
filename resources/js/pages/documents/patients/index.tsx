...
import { ArrowLeft, Upload, FileText, Clock, Shield, AlertTriangle } from 'lucide-react';
...
export default function PatientDocuments() {
    const { patient, documents } = usePage<PageProps>().props;
    ...
    return (
        <>
            <Head title={`Patient Documents - ${patient.first_name} ${patient.last_name}`} />
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
                ...
                {documents.length === 0 ? (
                    <EmptyState
                        ...
                        description="This patient has no uploaded documents."
                    />
                ) : (
