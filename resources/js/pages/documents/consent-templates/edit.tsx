...
export default function ConsentTemplateEdit() {
    const { template } = usePage<PageProps>().props;
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/documents/consent-templates/${template.id}`, {
            onSuccess: () => {
    ...
    return (
        <>
            <Head title="Edit Consent Template" />
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Edit Consent Template</h1>
