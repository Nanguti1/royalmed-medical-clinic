...
export default function ProcedureEdit() {
    const { procedure } = usePage<PageProps>().props;
    const { data, setData, put, processing, errors } = useForm({
        ...
        anesthesia_required: procedure.anesthesia_required,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/dental/procedures/${procedure.id}`, {
            onSuccess: () => {
    ...
    return (
        <>
            <Head title="Edit Dental Procedure" />
            <div className="flex h-full flex-1 flex-col gap-6 p-4 md:p-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Edit Dental Procedure</h1>
                        <p className="text-muted-foreground">Update procedure details.</p>
                    </div>
                </div>
